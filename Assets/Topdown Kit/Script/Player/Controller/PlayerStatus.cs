...
public class PlayerStatus : MonoBehaviour {
	...
	public int maxLv = 99; // 最大等级
	public int pointPerLv; // 当前等级
	public int startExp; // 当前经验
	public float multipleExp; //要达到的经验值
	...
	public SubAttribute statusAdd; //次级属性，来源于装备和技能
	public SumAttribute statusCal; //属性总和
	public SumEquip statusEquip;
	public StatusGrowth statusGrowth,growthSetting; //升级后属性成长值
	
	public float hpRegenTime; //自身的生命恢复
	public float mpRegenTime; //自身的魔法回复
